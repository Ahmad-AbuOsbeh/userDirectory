  ...
  search(searchText, filters, pageIndex, pageSize, callback) {
    ...
    const _search = () => {
      this.getFavorites(() => {
        this.getBadges((err, badges) => {
          ...
          console.log('userIds: 1:12', userIds);
    ...
    if (searchText) {
      return Lookup.search({ searchText, pageIndex, pageSize }, (error, ids) => {
        userIds = ids;
        console.log('idsssssssss from Lockup', ids);
        ...
        Users.search({ pageIndex, pageSize }, (err, users) => {
          ...
          if (users) {
            if (users.length < 50) {
              ...
              console.log(
                'new_time - old_time FINALLLLLLLLLLLLLLLLLLLLLLL TIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIMETIMT TIMT ITM TIME TIME',
                seconds_passed,
                seconds_passed / 1000
              );
